# fix-prompt-conventions-injection Specification

## Purpose
TBD - created by archiving change fix-and-test-fix-prompts-inject-conventions. Update Purpose after archive.
## Requirements
