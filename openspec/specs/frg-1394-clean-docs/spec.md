# frg-1394-clean-docs Specification
...
### Requirement: The pack-1394 clean-docs fixture SHALL name release 1.39.4
...
- **THEN** `core/test/fixtures/frg/pack-1394-tugboat-ship-1.39.4/clean-docs.json` SHALL exist
...
- **WHEN** the clean-docs fixture for pack `pack-1394-tugboat-ship-1.39.4` is added
