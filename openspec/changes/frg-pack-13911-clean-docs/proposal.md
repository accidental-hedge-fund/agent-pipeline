...
Issue #1216 is a factory-gate `clean-docs` pack instance for pack run
`pack-13911-tugboat-ship-1.39.11` (release `1.39.11`). The Factory Reliability
...
- The fixture names `release_version` as `1.39.11`.
...
- [ ] File `core/test/fixtures/frg/pack-13911-tugboat-ship-1.39.11/clean-docs.json`
      exists and parses as JSON.
- [ ] That fixture's `release_version` field equals the string `1.39.11`.
- [ ] A unit test in `core/test/` reads only that run-scoped path (no other
      pack-run fixture path).
- [ ] That test fails when the fixture's `release_version` is not `1.39.11`.
...
- `frg-pack-13911-clean-docs`: Run-scoped clean-docs fixture and unit test for
  pack run `pack-13911-tugboat-ship-1.39.11` (release `1.39.11`). The fixture
...
- **Tests only:** `core/test/fixtures/frg/pack-13911-tugboat-ship-1.39.11/clean-docs.json`
