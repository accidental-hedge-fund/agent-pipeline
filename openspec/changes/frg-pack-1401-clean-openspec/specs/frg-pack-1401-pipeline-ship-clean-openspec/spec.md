...
Pins the pack-1401-pipeline-ship-1.40.1 clean-openspec JSON fixture to release `1.40.1` so the Factory Reliability Gate can exercise one clean OpenSpec path without production behavior change.
