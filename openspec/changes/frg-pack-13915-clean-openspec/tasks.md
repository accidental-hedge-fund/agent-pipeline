...
- [x] 1.1 Add `core/test/frg-pack-13915-clean-openspec.test.ts` that reads
...
- [x] 2.2 Re-run `cd core && node --test --experimental-strip-types test/frg-pack-13915-clean-openspec.test.ts`
...
- [x] 3.2 Confirm the only active OpenSpec change is `frg-pack-13915-clean-openspec`
