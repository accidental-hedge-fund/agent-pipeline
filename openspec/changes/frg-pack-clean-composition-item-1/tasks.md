...
- [x] 1.1 Add a single-line (or single-bullet) provenance note under `docs/`
...
- [x] 2.2 Run `openspec validate frg-pack-clean-composition-item-1` and fix any
      structural errors
- [x] 2.3 Do not create a second OpenSpec change for the same issue
