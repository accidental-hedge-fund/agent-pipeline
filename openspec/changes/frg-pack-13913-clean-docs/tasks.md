...
- [ ] 3.2 Run `openspec validate frg-pack-13913-clean-docs` and `npm run ci` from the repo root. Verify both are green. Do not regenerate `plugin/` unless a `core/scripts/` file was edited
