...
- [x] 1.1 Add `core/test/frg-pack-13916-clean-openspec.test.ts` that reads only
      ...
      fixture exists
- [x] 1.2 Add `core/test/fixtures/frg/pack-13916-pipeline-ship-1.39.16/clean-openspec.json`
...
- [x] 2.1 After any `core/` edit run `node scripts/build.mjs`, then run
