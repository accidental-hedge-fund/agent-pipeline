...
Pins Factory Reliability Gate pack `pack-1401-pipeline-ship-1.40.1` to a run-scoped JSON fixture whose `release_version` is `1.40.1`, with a unit test that fails when that value changes.
