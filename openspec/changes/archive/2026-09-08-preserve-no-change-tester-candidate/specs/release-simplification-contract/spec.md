...
Records the approved release-simplification sequence and its five-package delivery boundary so later work can implement one coherent release path without expanding package 1.
