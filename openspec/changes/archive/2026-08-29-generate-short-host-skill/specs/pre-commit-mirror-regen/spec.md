...
- FROM: ### Requirement: A committed pre-commit hook SHALL refresh generated SKILL/catalog outputs when core/, hosts/claude/, or hosts/_shared/ paths are staged
- TO: ### Requirement: A committed pre-commit hook SHALL refresh exact generated SKILL/catalog outputs when generator inputs or generated host SKILLs are staged
