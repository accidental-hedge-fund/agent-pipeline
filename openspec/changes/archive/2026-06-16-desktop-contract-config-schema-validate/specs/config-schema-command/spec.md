...
Exposes the JSON Schema for `.github/pipeline.yml` as a CLI command so Pipeline Desk and editor integrations can validate and autocomplete config files without duplicating or importing the engine's Zod schema.
