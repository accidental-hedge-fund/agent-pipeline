...
- [x] 1.6 Require a runner-issued HMAC `integrity.score_receipt` that binds computed `pass` to the run; reject a hand-edited `pass: true` and a reminted public receipt
