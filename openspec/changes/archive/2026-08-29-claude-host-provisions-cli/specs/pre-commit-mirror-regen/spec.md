...
**Reason:** #1048 retires the committed plugin core mirror, so the hook no longer regenerates or stages that mirror as required output.

**Migration:** The hook refreshes and stages only generator-owned SKILL/catalog outputs.
