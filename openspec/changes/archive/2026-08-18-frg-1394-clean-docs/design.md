...
`core/test/fixtures/frg/` does not exist on this branch. The `clean-docs`
pack template (`core/scripts/frg-packs/factory-gate-v1/templates/clean-docs.md`)
...
**Choice:** Spec this instance as `frg-1394-clean-docs`.
...
would bake `pack-1394-tugboat-ship-1.39.4` into pack law.
