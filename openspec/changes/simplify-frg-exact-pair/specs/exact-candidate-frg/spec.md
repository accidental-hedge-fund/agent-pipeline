...
Defines the release-owned final regression gate that proves one exact main candidate can complete exactly two retained harmless fixtures through the ordinary pipeline without merge.
