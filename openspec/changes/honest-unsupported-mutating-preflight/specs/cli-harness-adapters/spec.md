...
### Requirement: Mutating implementation work SHALL refuse omitted background_job_lifecycle and SHALL spawn explicit non-support
...
#### Scenario: Explicit unsupported implementer is spawned
