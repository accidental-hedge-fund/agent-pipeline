...
Factory Reliability Gate (FRG) pack run `frg-1.40.1-c9433f3fd39b` needs one synthetic
...
- Add one run-scoped JSON fixture at
  `core/test/fixtures/frg/frg-1.40.1-c9433f3fd39b/clean-docs.json` with
  `release_version` exactly `1.40.1`.
- Add one executable Node unit test at
  `core/test/frg-frg-1.40.1-c9433f3fd39b-clean-docs.test.ts` that reads only that
...
- `frg-1-40-1-c9433f3fd39b-clean-docs`: run-scoped clean-docs fixture identity
  for pack run `frg-1.40.1-c9433f3fd39b` and release `1.40.1`, plus the
...
- **Product files:** only
  `core/test/fixtures/frg/frg-1.40.1-c9433f3fd39b/clean-docs.json` and
  `core/test/frg-frg-1.40.1-c9433f3fd39b-clean-docs.test.ts`.
...
- [ ] `core/test/fixtures/frg/frg-1.40.1-c9433f3fd39b/clean-docs.json` exists
      and its parsed `release_version` is exactly `1.40.1`.
- [ ] `core/test/frg-frg-1.40.1-c9433f3fd39b-clean-docs.test.ts` exists, reads
