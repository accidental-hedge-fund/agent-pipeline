...
`frg-1.40.1-c9433f3fd39b` and Pipeline release `1.40.1`. The capability covers
...
`core/test/fixtures/frg/frg-1.40.1-c9433f3fd39b/clean-docs.json`. That fixture
...
- **WHEN** `core/test/fixtures/frg/frg-1.40.1-c9433f3fd39b/clean-docs.json` is
...
`core/test/frg-frg-1.40.1-c9433f3fd39b-clean-docs.test.ts`. That test SHALL
read only
`core/test/fixtures/frg/frg-1.40.1-c9433f3fd39b/clean-docs.json`, parse it, and
...
- **WHEN** `cd core && node --test --experimental-strip-types test/frg-frg-1.40.1-c9433f3fd39b-clean-docs.test.ts`
...
`core/test/fixtures/frg/frg-1.40.1-c9433f3fd39b/clean-docs.json`,
`core/test/frg-frg-1.40.1-c9433f3fd39b-clean-docs.test.ts`, and this issue's
OpenSpec change `openspec/changes/frg-1-40-1-c9433f3fd39b-clean-docs/` (and,
after archive, `openspec/specs/frg-1-40-1-c9433f3fd39b-clean-docs/spec.md`).
...
this fixture SHALL be `openspec/specs/frg-1-40-1-c9433f3fd39b-clean-docs/spec.md`.
...
`openspec/changes/frg-1-40-1-c9433f3fd39b-clean-docs/` into
`openspec/specs/frg-1-40-1-c9433f3fd39b-clean-docs/spec.md`. After archive,
...
- **THEN** the archived living spec SHALL be
  `openspec/specs/frg-1-40-1-c9433f3fd39b-clean-docs/spec.md`
