...
Issue #1136 is the Factory Reliability Gate (FRG) `clean-docs` item for
...
- Add a run-scoped JSON fixture at
  `core/test/fixtures/frg/pack-1394-tugboat-ship-1.39.4/clean-docs.json`.
- Add a unit test that reads that fixture from that path only and
  asserts `release_version` is `1.39.4`.
...
- [ ] File `core/test/fixtures/frg/pack-1394-tugboat-ship-1.39.4/clean-docs.json` exists and is valid JSON.
...
- `frg-1394-clean-docs`: Run-scoped clean-docs fixture and unit test for
