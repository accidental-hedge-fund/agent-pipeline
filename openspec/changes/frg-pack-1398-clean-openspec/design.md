...
See `proposal.md` for why. Issue #1189 is a synthetic Factory Reliability
Gate (FRG) pack item (`template_id=clean-openspec`,
`pack_run_id=pack-1398-tugboat-ship-1.39.8`). It is not an engine-dogfood
...
- One co-located unit test that asserts `release_version === "1.39.8"`.
- Keep this the only active OpenSpec change for #1189.
...
**Choice:** The fixture uses `release_version` with value `1.39.8`.
...
**Choice:** Add `core/test/frg-pack-1398-clean-openspec.test.ts`. It reads
...
`frg-pack-1398-clean-openspec` into
`openspec/specs/frg-pack-1398-clean-openspec/spec.md`. Rollback is revert
