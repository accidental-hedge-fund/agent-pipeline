...
- [ ] 1.1 Add `core/test/frg-13913-clean-openspec.test.ts` that reads
...
- [ ] 2.2 Re-run `cd core && node --test --experimental-strip-types test/frg-13913-clean-openspec.test.ts`
...
- [ ] 3.2 Confirm the only active OpenSpec change is `frg-13913-clean-openspec`
