...
Pin a run-scoped clean-docs JSON fixture and unit test for factory-gate pack `pack-1401-pipeline-ship-1.40.1` so the Pipeline can exercise one clean documentation path without changing production behavior.
