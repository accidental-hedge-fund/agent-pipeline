...
- [ ] 1.1 Add `core/test/frg-pack-1401-clean-docs.test.ts` that reads
...
- [ ] 2.2 Re-run `cd core && node --test --experimental-strip-types test/frg-pack-1401-clean-docs.test.ts`
...
- [ ] 3.2 Confirm the only active OpenSpec change is `frg-pack-1401-clean-docs`
