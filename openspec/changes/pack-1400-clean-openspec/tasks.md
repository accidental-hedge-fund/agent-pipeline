...
- [ ] 1.1 Add `core/test/frg-pack-1400-clean-openspec.test.ts` that reads only
      ...
      fixture exists
- [ ] 1.2 Add `core/test/fixtures/frg/pack-1400-pipeline-ship-1.40.0/clean-openspec.json`
