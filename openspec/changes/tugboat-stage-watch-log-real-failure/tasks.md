...
- [ ] 3.2 Run `openspec validate tugboat-stage-watch-log-real-failure` and `npm run ci` from the repo root. Verify both are green. Do not present `PIPELINE_MATERIAL_FILTER` as this issue’s fix. Do not kill or restart an in-flight ship
