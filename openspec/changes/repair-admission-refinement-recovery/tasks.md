...
- [x] 2.3 Keep the full-body 65,536-character check before every publication caller; verify the eleven-node reproduced body fits, genuinely unique oversize content throws before injected issue mutation, no evidence/node is truncated, and unrelated issue sections survive unchanged.
