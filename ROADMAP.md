...
| **v1.28.3** | patch | Loop progress + pre-merge recovery: stage progress, dual-follow, CI/delta auto-fix recovery, offramp metrics, event-follow terminal exit | #554, #611, #615, #679, #680, #681, #682, #683, #684, #699 | Planned. #698 deferred (conflict re-base after pre-merge stack). |
