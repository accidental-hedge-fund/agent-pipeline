...
| **v1.28.1** | patch | Factory-hardening patch: loop needs-human hold + phantom `pipeline:blocked` run-fatal fix, evaluator isolation restoration, eval effort/verdict correctness, repo-configurable harness roles, and loop-surface papercuts | #616, #607, #608, #610, #614, #620, #621, #625, #606, #609 | _Planned patch on the 1.28 line._ |
