...
| **v1.29.0** | minor | Docs/packaging truth, plan-review authority docs, human-gated merge-queue (dry-run + release-when-complete), evals ordered primary-reviewer pairs | #574, #627, #673, #676, #601 | Closeout ship of completed v1.29.0 milestone items after multi-item loop; reliability deferred to v1.29.1 |
