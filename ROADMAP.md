...
| **v1.4.0** | minor | Graduated autonomy, evals & private gates | #23, #149, #148 | #23 (graduated-autonomy approval checkpoints) + #149 (bounded auto-loop, depends on #23) carried over from v1.3.0 — #23 recurrence-parked on a checkpoint forge-resistance security property (PR #194 open). Plus #148: an optional reviewer-owned private shipcheck gate before `ready-to-deploy` (advisory-first). All opt-in; no default behavior change. |
