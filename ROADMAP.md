...
**v1.15.2 — Reviewer CLI model/effort passthrough: honor configured `models.review` + `effort.review` for the codex reviewer (shipped 2026-07-20, tag `v1.15.2`):**
...
| **v1.15.2** ✅ shipped | patch | Reviewer CLI model/effort passthrough: honor configured `models.review` + `effort.review` for the codex reviewer | #441 | Shipped 2026-07-20 (tag `v1.15.2`). See **Shipped** above for the per-PR detail. |
