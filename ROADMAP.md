...
| **v1.28.2** | patch | Loop progress followability + factory papercuts: early handoff, durable logs follow, advance-run linkage, long-running skill packaging; worktree reclaim safety, open-PR pagination, nested node_modules verify, plan-revision Feedback Incorporated repair | #622, #623, #624, #658, #665, #666, #667, #668 | _Planned patch on the 1.28 line._ |
