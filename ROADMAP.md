...
| **v1.19.0** | minor | Objective grading + API comparison: eval graders with statistical reporting + OpenRouter executor experiment controls | #433, #434 | Objective per-cell graders with failure-class exclusion and comparative statistics (#433); OpenRouter request-parameter treatments with strict provider-routing validation and response provenance (#434). |
