...
| **v1.15.1** | patch | Foundation reliability + release hygiene | #401, #402, #413, #423 | All four fixes already merged to main (PRs #416, #417, #414, #439): intake/sweep spec capture + tool-free spec-prompt instruction, concurrent-fetch ref-lock retry, and the release-tag-token checkout guard. First patch on the 1.15 line; no config or behavior changes beyond the fixes. |
