...
| **v1.20.0** | minor | Risk-triggered design-interrogation gate + large-prompt harness delivery | #436, #492 | Opt-in design-interrogation gate with durable, byte-bounded decision evidence on risk-triggering changes (#436); harness prompts delivered via stdin so reviews of large diffs no longer fail the argv per-argument limit (#492). |
