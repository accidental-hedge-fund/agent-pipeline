...
| **v1.12.3** | patch | Fix harness commit step lock-file side-effects | #358 | Fix round amend sweeps in npm lock-file side-effects after a fix commit; copy entries treated as non-deletions in restore. |
