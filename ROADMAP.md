...
| **v1.26.0** | minor | Integrated Durable Orchestration: in-repo pipeline:loop supervisor + conflict-aware parallel execution | #509, #510, #511, #512, #513, #538, #514, #515, #529, #530, #531, #528 | Typed blockers/recovery (#509), pause+authority amendments (#510), truth reconciliation (#511), in-repo supervisor/resume/audit (#512), dependency deadlocks (#513), blocker auto-file (#538), /goal bootstrap docs (#514), two-item live pilot (#515), ownership surfaces (#529), independent-set scheduler (#530), parallel pilot (#531), epic integration (#528). |
