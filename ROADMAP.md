...
| **v1.22.0** | minor | Factory robustness: fix-stage recovery, gate/installer/worktree hardening, structured fix outcomes | #486, #484, #485, #450, #443, #472, #473, #506 | Fix-stage crash and zero-commit abandonment recovery (#486); human-input gate recognizes its own unblock/override comments (#484); detached runs validate cwd before creating stores (#485); auto-update never swaps skill files under live runs (#450); plan-revision prompt verifier coherence (#443); cross-checkout worktree resolution with fail-closed ownership (#472); structured non-code fix outcomes with preserved blocker disposition (#473); native-goal capability probe fixed for slash-command CLIs (#506). |
