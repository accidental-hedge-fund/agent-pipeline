...
| **v1.18.0** | minor | Controlled multi-harness evaluation foundation: Grok Build/Pi/OpenCode adapters + manifest-driven stage eval runner | #431, #432, #481 | Typed CLI harness adapters with native OAuth and provenance (#431); frozen-fixture, isolated-worktree eval runner (#432); pre-merge delta-review stale-SHA race fix with self-healing blocks (#481). |
