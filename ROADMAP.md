...
| **v1.28.4** | patch | Pre-merge auto-fix noop re-verify: do not hard-block when autofix makes no commit and HEAD already satisfies findings | #698 | Planned follow-on to v1.28.3. |
