    ...
    "findings": [
        {
            ...
            "rejected_alternatives": ["<optional: required when this recommendation removes or replaces an existing design — name the specific alternative(s) being ruled out>"]
        }
    ],
