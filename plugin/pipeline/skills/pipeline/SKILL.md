...
```bash
node ${CLAUDE_PLUGIN_ROOT}/skills/pipeline/scripts/pipeline.mjs logs <train-run-id> --events --follow \
  | node ${CLAUDE_PLUGIN_ROOT}/skills/pipeline/scripts/material-filter.mjs
```
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/skills/pipeline/scripts/pipeline.mjs loop logs <loop-run-id> --events --follow \
  | node ${CLAUDE_PLUGIN_ROOT}/skills/pipeline/scripts/material-filter.mjs
```
