...
#
#   ship-milestone.sh --milestone v1.33.0
#   ship-milestone.sh --milestone v1.33.0 --detach
#   ship-milestone.sh --milestones v1.33.0 v1.34.0 --detach
#   ship-milestone.sh --milestone v1.33.0 --status
#
...
usage() {
  cat <<'U'
Usage:
  ship-milestone.sh --milestone vX.Y.Z [--detach|--status]
  ship-milestone.sh --milestones vA.B.C[,vD.E.F ...] [--detach|--status]
