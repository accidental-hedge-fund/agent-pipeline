...
| `train-status-complete.py` | Pure helper for the playbook train gate: decode last `train_status` from mixed prose+JSON capture (`raw_decode`); prints `1`/`0` and writes `.blocker` when needed |
