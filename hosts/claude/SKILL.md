...
```bash
node ~/.claude/skills/pipeline/scripts/pipeline.mjs logs <train-run-id> --events --follow \
  | node ~/.claude/skills/pipeline/scripts/material-filter.mjs
```
...
```bash
node ~/.claude/skills/pipeline/scripts/pipeline.mjs loop logs <loop-run-id> --events --follow \
  | node ~/.claude/skills/pipeline/scripts/material-filter.mjs
```
