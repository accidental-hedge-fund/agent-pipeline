...
any substitute loop. Do not leave a live supervisor unobserved when the Codex
...
Poll or tail the loop events file and summarize material lifecycle records:
