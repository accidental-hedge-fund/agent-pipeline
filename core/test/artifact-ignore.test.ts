...
test("ARTIFACT_CONTRACT: contains exactly runs/, roadmap/, history/, evals/, control-attributions.jsonl, product-fault-reports.jsonl, handoffs/, and outcomes/ with non-empty comments", () => {
